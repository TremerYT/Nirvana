      ...
      <Row gutter={[16, 16]}>
        <Col span={16}>
          <Row gutter={[16, 0]}>
            ...
            <Col span={12}>
              <Form.Item
                name="discountValue"
                label={currentDiscountType === 'percentage' ? 'Discount (%)' : 'Discount (Ksh)'}
                rules={[
                  {
                    validator(_, value) {
              ...
              >
                <Space.Compact style={{ width: '100%' }}>
                  <InputNumber style={{ width: '100%' }} />
                  <Button disabled>{currentDiscountType === 'percentage' ? '%' : 'Ksh'}</Button>
                </Space.Compact>
              </Form.Item>
            </Col>
            ...
            {currentTaxType && (
              <Col span={8}>
                <Form.Item
                  name="productTax"
                  label={currentTaxType === 'percentage' ? 'Tax (%)' : 'Tax (Ksh)'}
                  rules={[
                    {
                      validator(_, value) {
                        if (!value) return Promise.resolve();
                ...
                >
                  <Space.Compact style={{ width: '100%' }}>
                    <InputNumber style={{ width: '100%' }} />
                    <Button disabled>{currentTaxType === 'percentage' ? '%' : 'Ksh'}</Button>
                  </Space.Compact>
                </Form.Item>
              </Col>
            )}
        ...
        <Col span={8}>
          <Row>
            ...
            <Col span={24}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: 'Pleas upload atleast one image variant of the product',
                  },
                ]}
              >
            ...
            <Col span={24}>
              <Form.Item name="addFeatured" valuePropName="checked">
                <Checkbox>This makes the product visible in the mobile app and the POS</Checkbox>
              </Form.Item>
            </Col>
            <Col span={24}>
              <Form.Item name="isPromotionalPrice" valuePropName="checked">
                <Checkbox>Add Promotional Sale</Checkbox>
              </Form.Item>
            </Col>
            {isPromotional && (
              <>
