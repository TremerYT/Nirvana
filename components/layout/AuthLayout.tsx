  ...
  return (
    <div className="min-h-screen w-full flex">
      <div className="lg:flex lg:w-1/2 relative bg-linear-to-br from-purple-600 to-purple-200">
        <div className="absolute inset-0 bg-[url('/login.jpeg')] bg-cover bg-center bg-no-repeat opacity-30" />
      ...
      <div className="flex flex-col p-8 w-1/2 bg-white h-full">{children}</div>
    </div>
  );
};
